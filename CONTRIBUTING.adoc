:uri-github-issue-pkl: https://github.com/apple/pkl-swift-examples/issues/new
:uri-seven-rules: https://cbea.ms/git-commit/#seven-rules

= Pkl Swift Examples Contributors Guide
...
Pkl Swift examples is released under the Apache 2.0 license.
